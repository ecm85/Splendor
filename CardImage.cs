...
namespace Splendor
{
	public class CardImage
	{
		...
		private const float borderThicknessInInches = (1.0f / 8.0f);
		private const float borderPaddingInInches = .05f;
		...
		public void PrintCardBorderAndBackground(Color? middleBorderColor, Color backgroundColor)
		{
